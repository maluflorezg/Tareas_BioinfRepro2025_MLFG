...
This session aims to introduce students to basic programming and the use of the command line (bash), with an emphasis on fundamental skills for bioinformatics, such as:
